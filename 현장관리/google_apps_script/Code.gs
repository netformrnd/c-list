...
const HEADERS = [
  ...
  '계약금_금액', '계약금_계산서', '계약금_입금일', '계약금_isRed', '계약금_manualPaid',
  '중도금1_금액', '중도금1_계산서', '중도금1_입금일', '중도금1_isRed', '중도금1_manualPaid',
  '중도금2_금액', '중도금2_계산서', '중도금2_입금일', '중도금2_isRed', '중도금2_manualPaid',
  '잔금_금액', '잔금_계산서', '잔금_입금일', '잔금_isRed', '잔금_manualPaid',
  'updatedAt'
];
...
function objectToRow(obj) {
  ...
  return [
    ...
    toNum(c1.amt), c1.bill || '', c1.paid || '', !!c1.isRed, !!c1.manualPaid,
    toNum(i1.amt), i1.bill || '', i1.paid || '', !!i1.isRed, !!i1.manualPaid,
    toNum(i2.amt), i2.bill || '', i2.paid || '', !!i2.isRed, !!i2.manualPaid,
    toNum(b1.amt), b1.bill || '', b1.paid || '', !!b1.isRed, !!b1.manualPaid,
